    ...
    public sealed class ArquivoEFDFiscal : ArquivoSped
    {
        ...
        private void LerBlocoC(RegistroSped registro)
        {
            if (BlocoC == null)
            {
                ...
                /*
                * Cria o C001 com movimento caso n�o exista no arquivo,
                * isso � feito para os cen�rios onde ser� realizada a
        ...
        public override void CalcularBloco9(bool totalizarblocos = true)
        {
            ...
            if (totalizarblocos) //Calcula os X990 de todos os blocos e readiciona as linhas de totaliza��o -> |X990|
            {
